  ...
  return (
    <motion.button
      ...
      className={`
        ...
        shadow-card-3d
        ${isInSlot ? 'w-full h-full' : (isNumber ? 'w-[3.8rem] h-[5rem] sm:w-[5.5rem] sm:h-[7.5rem]' : (gifInfo?.aspect === 'landscape' ? 'w-[4.8rem] h-[5rem] sm:w-[14rem] sm:h-[11rem]' : 'w-[3.8rem] h-[5rem] sm:w-[8.5rem] sm:h-[11rem]'))}
